 ...
 * @author Nathan
 */
public class UpdateSongYear {
    public static void update_songyear() {
        ...
        if (connection != null) {
            try {
                ...
                Song.setText("");
                Years.setText("");
                ResultSet res = st.executeQuery("Select * From Track_year  Where song_title like'" + son + "%' and year = '" +ye+"'limit "+result+"");//artist_name='someartist'
